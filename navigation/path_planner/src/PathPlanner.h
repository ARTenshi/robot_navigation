...
public:
    ...
    // add by ry0hei kobayashi 2025/06/11
    static bool AStarWithViaPoints(nav_msgs::OccupancyGrid& map, nav_msgs::OccupancyGrid& cost_map, geometry_msgs::Pose& startPose, std::vector<geometry_msgs::Pose>& via_poses, geometry_msgs::Pose& goalPose, bool diagonal_paths, nav_msgs::Path& resultPath);
    static void addViaPointBias(nav_msgs::OccupancyGrid& cost_map, const geometry_msgs::Pose& via_pose, double radius = 0.5, int cost_bias = 50);
